...
public:
    static inline void Save(std::ostream& out, const std::string& object) {
        unsigned short size = object.size();
        out.write((const char*)(&size), 2);
        out.write((const char*)(&object[0]), object.size());
    }
...
template <> class TSerializer<int8_t>: public TPodSerializer<int8_t> {};
